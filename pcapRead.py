...
packet = rdpcap('temp.pcap')[0]
features = packetFeatures(packet)
print("Source Port:", features[0])
print("Destination Port:", features[1])
print("IP Length:", features[2])
print("TCP Flags:", features[3])
print("UDP Length:", features[4])